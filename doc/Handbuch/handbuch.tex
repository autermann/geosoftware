% created by Christian Paluschek


\documentclass[a4paper,10pt]{scrartcl}


\usepackage[ngerman]{babel} %zb deutsches verzeichnis%
\usepackage[T1]{fontenc}
\usepackage[ansinew]{inputenc}
\usepackage{lmodern}
\usepackage{graphicx} %einladen von grafiken%
\usepackage{amsmath}
\usepackage{hyperref}
\usepackage{amsthm}
\usepackage{amsfonts}
\usepackage{textcomp} %eurozeichen lässt sich laden%
...
\hypersetup{colorlinks=true, breaklinks=true, linkcolor=black, menucolor=black, urlcolor=darkblue}
...
%%% Kopfzeile linker Bereich
%      gerade Seite             ungerade Seite
\rhead[\rightmark]{sloth.city}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% DOCUMENT
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\parindent 0pt %text nicht einrücken%

\begin{titlepage}
\copyright sloth.city \\
...
Die aufgelisteten Anforderungen sollten in jedem Fall erfüllt werden, damit eine zufriedenstellende Nutzung gewährleitet werden kann.
...
\begin{itemize}
	...
	\item Opera 10.10 \\\url{http://www.server-56.info/Opera/}
\end{itemize} 
...
Die eingetragenen \textbf{Beobachtungen} werden untereinander auf der linken Seite direkt neben der Karte dargestellt. Jedes Symbol hat ihre eigene Kategorie. Wird eine Beobachtung in der Karte nicht gefunden, kann die Zoomfunktion benutzt werden.
...
Die erwähnten Funktionen im Überlick Abschnitt kann ein Besucher dieser Webseite vollständig ausführen (außer Beobachtungen anlegen!).
...
Als Aministrator obligt einem die Verwaltung der Benutzer, Beobachtungen, Kategorien und Meldungen. Nur der Administrator kann Benutzer löschen, alle Beobachtungen editieren, Kategorien erstellen, editieren, löschen sowie Meldungen editieren und löschen.  

Die Registierung des Administrators erfolgt über eine Besonderheit. Der erste Benutzer der Webseite ist gleichzeitig auch der Administrator.
