...
\section{Technische Produktumgebung}
	...
	\subsection{Produktschnittstellen}
		Implementierung eines WFS zum Zugriff auf eingetragene Daten (vorraussichtlich umgesetzt durch einen GeoServer (v2.0.0)).
...
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{./Grobplanung/Overview.emf}
		\caption{Überblick über die zu erstellenden Pakete}
		\label{componentoverview}
\end{figure}
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{./Grobplanung/Logik.emf}
		\caption{Detaillierter Aufbau des Logik-Paketes}
		\label{componentlogic}
\end{figure}
\begin{figure}[htbp]
	\centering
		\includegraphics[width=1.00\textwidth]{./Grobplanung/AnwendungsFallDiagramm.emf}
		\caption{Ermitlung der Anwendungsfälle}
