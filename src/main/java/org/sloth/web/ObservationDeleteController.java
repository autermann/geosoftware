...
@Controller
@RequestMapping("/observations/delete/{id}")
@SessionAttributes(types = Observation.class)
public class ObservationDeleteController {

    protected static final Logger logger = LoggerFactory.getLogger(
			ObservationDeleteController.class);
	...
	public String processSubmit(@ModelAttribute Observation observation, BindingResult result,
		...
		if (result.hasErrors()) {
			...
			this.observationManager.deleteObservation(observation);
			status.setComplete();
			return "redirect:/observations";
		}
	}
