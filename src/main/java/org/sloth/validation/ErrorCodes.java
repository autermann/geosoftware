...
public class ErrorCodes {
	...
	public static final class REGISTRATION {
		...
		/**
		 * Indicating that the entered mail address repetition is {@code null}
		 * or empty.
		 */
		...
		/**
		 * Indicating that the entered passwordrepetition is {@code null} or
		 * empty.
		 */
	...
	public static final class USER_EDIT {
		...
		/**
		 * Indicating that the editing user has not the appropiate rights to
		 * change the group.
		 */
		...
		/**
		 * Indicating that the entered new mail address is {@code null} or
		 * empty.
		 */
		...
		/**
		 * Indicating that the entered new password repeat is {@code null} or
		 * empty.
		 */
